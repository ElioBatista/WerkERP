<%@ Page Title="Iniciar sesión" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="WerkUI.Account.Login" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <section id="loginForm">
        ...
        <asp:Login runat="server" ViewStateMode="Disabled" RenderOuterTable="false"  ID="Login1" OnAuthenticate="Login1_Authenticate" >
            <LayoutTemplate>
