<%@ Page Title="Ordenes de Pago" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OP.aspx.cs" Inherits="WerkUI.OrdenPago.OP" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <asp:UpdatePanel ID="upnlOP" runat="server">
        <ContentTemplate>
            <div class="site-title">
                <asp:Label ID="lblSiteTitle" runat="server" Visible="True" CssClass="main-content" Text="Aprobación de Solicitudes de OP" />
            </div>
            <div>
                ...
                <ItemTemplate>
                    <tr>
                        <td> 
                         ...
                         <td>
                            <asp:Label ID="lblUsuario" runat="server" Text='<%# WerkUI.OrdenPago.OP.GetUserLogin( Item.cod_usuario )%>' />
                        </td>
                        <td>
                        ...
                        <td class="text-right">
                            ...
                            <asp:Button ID="DetailsButton" runat="server" Text="Aprobar" PostBackUrl='<%# "~/OrdenPago/OPDetails.aspx?RequestID=" + Eval("id_solicitud_orden_pago") + "&RequestNumber=" + Eval("nro_comprobante") %>' />
                        </td>
                    </tr>
                </ItemTemplate>
                <EditItemTemplate>
